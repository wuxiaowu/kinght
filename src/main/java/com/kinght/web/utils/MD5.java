...
public class MD5 {
    ...
    public static void main(String[] args) {
        String data = "0000zealot";
        MD5 md5 = new MD5();
        System.out.println(data);
        System.out.println(md5.getMD5ofString(data.getBytes(),
                data.getBytes().length).toLowerCase().equalsIgnoreCase("64c80e8faf6b547d52ec4776bdd64992"));
    }
}